...
([["","file:///C:/Users/Daniel/dart/daaart/web/Obstacle.dart",,E,{
"":"",
iH:{
"":"a;x*,y,fg,R,ih,MY",
Tx:function(a,b){var z=this.x
if(typeof z!=="number")return H.s(z)
if(a-8>=z&&a+8<=z+this.R){if(typeof b!=="number")return b.g()
z=this.y
if(b+8<z||b-8>z+this.fg)return!0}return!1},
HN:function(a){J.yc(a,this.ih)
a.fillRect(this.x,0,this.R,this.y)
a.fillRect(this.x,this.y+this.fg,this.R,a.canvas.height)},
qz:function(a,b){var z,y
this.x=a
this.fg=C.pr.j1(80)+80
this.R=C.pr.j1(50)+30
z=this.fg
...
this.ih=z[y]}}}],["_foreign_helper","dart:_foreign_helper",,H,{
"":"",
FK:{
...
eG:function(a,b){return H.Z9(a["$as"+H.d(b)],H.oX(a))},
...
VX:{
"":"Tp:12;c",
call$1:function(a){return this.c(a)}}}],["","file:///C:/Users/Daniel/dart/daaart/web/daaart.dart",,G,{
"":"",
QL:[function(){C.ol.gm6(window).ml(G.lS())
G.IM()},"call$0","HA",0,0,0],
E2:[function(a){var z,y,x,w,v,u,t
z=$.H9()
J.Eu(z,0,0,z.canvas.width,z.canvas.height)
z=$.DB
...
z/=20
if(z<1.5707963267948966)z=Math.cos(z)*10
else z=0
z=y+x-z
$.qp=z
y=$.PX()
...
x=v}else x=!0
if(x){x=$.H9()
w=new E.iH(null,null,null,null,null,["yellow","green","red","blue"])
w.qz(x.canvas.width,x.canvas.height)
y.push(w)
$.n0=$.pB().j1(200)+500}for(y=$.PX(),y=new H.a7(y,y.length,0,null);y.G();){u=y.mD
x=J.RE(u)
w=x.gx(u)
if(typeof w!=="number")return w.W()
x.sx(u,w-6)
u.HN($.H9())
if(u.Tx(100,z)){J.yc($.H9(),"red")
z=$.H9()
J.HM(z,0,0,z.canvas.width,z.canvas.height)
J.yc($.H9(),"white")
J.PB($.H9(),"30px Arial")
J.xJ($.H9(),"Game over!",300,120)
J.hp(document.querySelector("#audioGameOver"))
return}}J.Dg($.H9())
t=document.querySelector("#dart")
J.cb($.H9(),t,100,z,32,32)
C.ol.gm6(window).ml(G.lS())},"call$1","lS",2,0,1],
IM:function(){var z=H.VM(new W.RO(window,C.rl.Ph,!1),[null])
H.VM(new W.xC(0,z.uv,z.Ph,W.VF(new G.MG()),z.Sg),[H.Kp(z,0)]).Zz()},
MG:{
"":"Tp:13;",
call$1:function(a){if(J.Zm(a)===32){$.DB=0
J.hp($.p5())}}}},1],["dart._collection.dev","dart:_collection-dev",,H,{
"":"",
...
$asMO:null}}],["dart.dom.svg","dart:svg",,P,{
"":"",
jw:{
"":"d5;fg:height=,x=",
"%":"SVGFEBlendElement"},
...
I.$lazy($,"canvas","qN","jY",function(){return document.querySelector("#game")})
I.$lazy($,"ctx","Ee","H9",function(){return J.Yd($.jY(),"2d")})
I.$lazy($,"lastHeight","qp","UE",function(){var z=J.OB($.jY())
if(typeof z!=="number")return z.V()
return z/2+15})
I.$lazy($,"rand","SQ","pB",function(){return C.pr})
I.$lazy($,"plop","hr","p5",function(){return document.querySelector("#plop")})
I.$lazy($,"queue","iq","PX",function(){return[]})
...
init.metadata=[{func:"X0",void:true},{func:"G5",void:true,args:[null]},{func:"Vx",void:true,args:[null],opt:[P.mE]},,{func:"Gl",ret:J.kn,args:[null,null]},{func:"bX",ret:J.im,args:[null]},{func:"E0",ret:J.kn,args:[P.a,P.a]},{func:"ZY",ret:J.im,args:[P.a]},{func:"NT"},{func:"bh",args:[null,null]},{func:"aB",args:[null]},{func:"TS",args:[null,J.O]},{func:"zx",args:[J.O]},{func:"c0",args:[W.HL]},{func:"BG",args:[null],opt:[null]},{func:"bb",args:[null,P.mE]},{func:"lv",args:[P.wv,null]},{func:"Pt",ret:J.O,args:[J.im]},];$=null
...
;(function (callback) {
  ...
  if (typeof dartMainRunner === "function") {
    dartMainRunner(function() { H.Rq(G.HA()); });
  } else {
    H.Rq(G.HA());
  }
})
...
if($desc instanceof Array)$desc=$desc[1]
n6.prototype=$desc
function iH(x,y,fg,R,ih,MY){this.x=x
this.y=y
this.fg=fg
this.R=R
this.ih=ih
this.MY=MY}iH.builtin$cls="iH"
if(!"name" in iH)iH.name="iH"
$desc=$collectedClasses.iH
if($desc instanceof Array)$desc=$desc[1]
iH.prototype=$desc
iH.prototype.gx=function(receiver){return this.x}
iH.prototype.sx=function(receiver,v){return this.x=v}
...
if($desc instanceof Array)$desc=$desc[1]
Rd.prototype=$desc
return[qE,Gh,rK,fY,Mr,lJ,ct,nB,i3,it,QP,IF,Ny,Kh,TK,Y5,Gc,QQ,y4,d7,Um,DG,mN,vH,xO,Em,NW,rV,Wy,QF,cm,Nh,cv,Fs,hY,ea,D0,as,Aa,u5,Yu,iG,jP,Ax,xf,Vb,ST,tb,pA,Mi,HL,In,wP,eP,A6,Og,M6,El,mC,SV,aB,fJ,Ih,D8,Vh,rC,ZY,cx,P1,Qb,PG,F3,xI,Aj,oU,eY,KV,KY,G7,l9,Ql,wL,bP,FH,SN,HD,ni,rR,qj,KR,ew,fs,bX,lr,MC,iQ,j2,Ea,lp,kd,yN,Cp,ua,HN,Ul,KK,ii,fq,h4,qk,GI,Tb,Iv,BT,yY,FB,xV,Pe,y6,RH,Kn,Z2,w6,BR,vw,aG,J6,Oi,r0,nK,yp,c1,Mq,Nf,Nc,Mx,Q7,yK,Dh,ZJ,mU,eZ,IT,JY,Pq,kx,nV,ui,D6,DQ,Sm,xL,es,jw,lv,pf,NV,W1,zo,wf,TU,ih,Nd,zp,Xu,lu,tk,me,oB,Ah,d4,MI,Ub,bM,eW,Qy,ju,OE,N9,BA,tp,rE,CC,PQ,uz,hB,p8,AD,Gr,Gq,GH,To,NJ,qI,jf,rQ,Lx,d5,hy,r8,aS,CG,UN,MT,xN,Eo,ZG,UM,ZD,vt,wD,BD,vR,j8,Ja,zI,cB,LQ,yR,HP,fa,l4,Et,QS,Pi,qO,xt,tG,P0,xl,Xr,Sl,Jo,Qm,HY,n6,iH,FK,Gv,kn,CD,Ue,iC,is,Q,P,im,VA,O,PK,JO,O2,aX,cC,RA,IY,JH,jl,Iy,JM,Ua,ns,yo,fc,Bj,NO,II,fP,X1,HU,oo,OW,Tf,AP,yH,FA,Av,FD,Zr,W0,az,vV,Am,XO,dr,TL,KX,uZ,OQ,Tp,Bp,v,Eq,lb,tD,hJ,cu,dC,wN,VX,MG,a7,i1,xy,MH,SU,Ca,b8,Pf,Zf,vs,da,xw,dm,rH,mi,jb,wB,Pu,qh,lz,Rl,Jb,M4,B5,PI,MO,Kd,UO,Bc,VT,Fj,q1,Zz,ly,MF,u8,yU,nP,KA,qB,ez,fI,LV,dp,B3,CR,Qk,v1,uR,fZ,TF,K5,Cg,Hs,pK,eM,R8,k6,oi,fG,EQ,YB,a1,db,i5,N6,jg,YO,oz,b6,tj,zQ,u3,mW,lD,ZQ,Sw,o0,CL,a6,P7,DW,Ge,LK,AT,bJ,ub,ds,lj,UV,VS,t7,HG,kM,An,c8,a,mE,Rn,wv,YS,Fk,RO,xC,mg,ue,iY,C0,Rd]}