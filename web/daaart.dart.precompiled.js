...
["", "Obstacle.dart", , E, {
  "": "",
  Obstacle: {
    "": "Object;x*,y,height,width>,color,colors",
    checkCollision$2: function(xDart, yDart) {
      var t1 = this.x;
      if (typeof t1 !== "number")
        return H.iae(t1);
      if (xDart + 30 >= t1 && xDart <= t1 + this.width) {
        t1 = this.y;
        if (typeof yDart !== "number")
          return yDart.$lt();
        if (yDart < t1 || yDart + 30 > t1 + this.height)
          return true;
      }
      return false;
    },
    paint$1: function(ctx) {
      J.set$fillStyle$x(ctx, this.color);
      ctx.fillRect(this.x, 0, this.width, this.y);
      ctx.fillRect(this.x, this.y + this.height, this.width, ctx.canvas.height);
    },
    Obstacle$2: function(xStart, canvasHeight) {
      var t1, t2;
      this.x = xStart;
      this.height = C.C__JSRandom.nextInt$1(80) + 80;
      this.width = C.C__JSRandom.nextInt$1(50) + 30;
      t1 = this.height;
      if (typeof canvasHeight !== "number")
        return canvasHeight.$sub();
      this.y = C.C__JSRandom.nextInt$1(canvasHeight - t1);
      t1 = this.colors;
...
["", "daaart.dart", , G, {
  "": "",
  main: [function() {
    C.Window_methods.get$animationFrame(window).then$1(G.draw$closure());
    G.initListeners();
    J.play$0$x(document.querySelector("#welcome"));
  }, "call$0", "main$closure", 0, 0, 0],
  draw: [function(num) {
    var t1, t2, t3, t4, t5, obs, i, img;
    t1 = $.get$ctx();
    J.clearRect$4$x(t1, 0, 0, t1.canvas.width, t1.canvas.height);
    t1 = $.timeUp;
    if (typeof t1 !== "number")
      return t1.$add();
    ++t1;
    ...
    if (t3) {
      t3 = $.get$ctx();
      t4 = new E.Obstacle(null, null, null, null, null, ["yellow", "green", "red", "blue"]);
      t4.Obstacle$2(t3.canvas.width, t3.canvas.height);
      t2.push(t4);
      $.margin = $.get$rand().nextInt$1(200) + 500;
    }
    for (t2 = $.get$queue(), t2 = new H.ListIterator(t2, t2.length, 0, null), obs = false; t2.moveNext$0();) {
      i = t2._current;
      t3 = J.getInterceptor$x(i);
      t4 = t3.get$x(i);
      if (typeof t4 !== "number")
        return t4.$sub();
      t3.set$x(i, t4 - 6);
      ...
      i.paint$1($.get$ctx());
      if (i.checkCollision$2(100, t1)) {
        J.set$fillStyle$x($.get$ctx(), "red");
        t1 = $.get$ctx();
        J.fillRect$4$x(t1, 0, 0, t1.canvas.width, t1.canvas.height);
        J.set$fillStyle$x($.get$ctx(), "white");
        J.set$font$x($.get$ctx(), "30px Arial");
        J.set$textAlign$x($.get$ctx(), "center");
        t1 = $.get$ctx();
        t2 = t1.canvas.width;
        if (typeof t2 !== "number")
          return t2.$div();
        J.fillText$3$x(t1, "Game over!", t2 / 2, 120);
        J.set$font$x($.get$ctx(), "14px Arial");
        t2 = $.get$ctx();
        t1 = "Distance: " + C.JSInt_methods.toString$0($.distance) + " | Pipes: " + C.JSInt_methods.toString$0($.pipes) + " x 50";
        t3 = $.get$ctx().canvas.width;
        if (typeof t3 !== "number")
          return t3.$div();
        J.fillText$3$x(t2, t1, t3 / 2, 150);
        t3 = $.get$ctx();
        t1 = "Score:" + C.JSInt_methods.toString$0($.distance + $.pipes * 50);
        t2 = $.get$ctx().canvas.width;
        if (typeof t2 !== "number")
          return t2.$div();
        J.fillText$3$x(t3, t1, t2 / 2, 170);
        J.play$0$x(document.querySelector("#audioGameOver"));
        return;
      }
    }
    if (obs) {
    ...
    $.distance = $.distance + 1;
    J.beginPath$0$x($.get$ctx());
    img = document.querySelector("#dart");
    J.drawImageScaled$5$x($.get$ctx(), img, 100, t1, 32, 32);
    C.Window_methods.get$animationFrame(window).then$1(G.draw$closure());
  }, "call$1", "draw$closure", 2, 0, 1],
  initListeners: function() {
    var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, C.EventStreamProvider_keydown._eventType, false), [null]);
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new G.initListeners_closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  },
  initListeners_closure: {
    "": "Closure:13;",
    call$1: function(e) {
      if (J.get$keyCode$x(e) === 32) {
        $.timeUp = 0;
        J.play$0$x($.get$plop());
      }
    }
...
Isolate.$lazy($, "ctx", "ctx", "get$ctx", function() {
  return J.getContext$1$x($.get$canvas(), "2d");
});
Isolate.$lazy($, "lastHeight", "lastHeight", "get$lastHeight", function() {
  var t1 = J.get$height$x($.get$canvas());
  if (typeof t1 !== "number")
    return t1.$div();
  return t1 / 2 + 15;
});
...
Isolate.$lazy($, "plop", "plop", "get$plop", function() {
  return document.querySelector("#plop");
});
Isolate.$lazy($, "queue", "queue", "get$queue", function() {
  return [];
});
...
function dart_precompiled($collectedClasses) {
  ...
  function Obstacle(x, y, height, width, color, colors) {
    this.x = x;
    this.y = y;
    this.height = height;
    this.width = width;
  ...
  Obstacle.builtin$cls = "Obstacle";
  if (!"name" in Obstacle)
    Obstacle.name = "Obstacle";
  $desc = $collectedClasses.Obstacle;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Obstacle.prototype = $desc;
  Obstacle.prototype.get$x = function(receiver) {
    return this.x;
  };
  Obstacle.prototype.set$x = function(receiver, v) {
    return this.x = v;
  };
  Obstacle.prototype.get$width = function(receiver) {
    return this.width;
  };
